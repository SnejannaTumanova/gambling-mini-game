    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(_crd && WheelController === void 0 ? (_reportPossibleCrUseOfWheelController({
        ...
        increaseBet(amount) {
          ...
          var available = this.balance - this.currentBet.amount;
        ...
        play() {
          ...
          var isWin = this.gameService.rollWin(); // определяем исход

          var outcome = this.gameService.resolveRound(this.balance, this.currentBet, isWin);
          var prevBalance = this.balance;
        ...
        onSpinComplete(outcome, prevBalance) {
          ...
          var previousBetAmount = this.currentBet.amount;
          ...
          var displayAmount = outcome.isWin ? outcome.reward : previousBetAmount;
